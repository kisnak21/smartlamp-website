...
var filaEliminada;
  ...
  var coleccionProductos = db.ref().child("data_latih");
  var dataSet = [];
  var table;

  // datatable fetch firebase TrainData
  ...
  // Check if modified data is stored in localStorage
    var storedData = localStorage.getItem('modifiedData');
    if (storedData) {
...
// Click event handler for "Evaluasi Model" button
    $("#evalModel").click(function() {
        // Display IziToast message
        iziToast.info({
            title: 'Info',
